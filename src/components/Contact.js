    ...
    return (
        <div className="contact-page">
            ...
            <div className="info-sidebar">
                ...
                <div className="info-card">
                    <p>
                        Nossos projetos dão forma à vida como ela deve ser: completa, exclusiva e grandiosa. Em cada detalhe, um desejo. Em cada ambiente, uma inspiração. Em cada apartamento, uma conquista. Se você está em busca de um imóvel com muitas qualidades, oferecemos o melhor conjunto delas.
                    </p>
                </div>
            </div>
        </div>
